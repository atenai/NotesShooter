...
public static class ScrollRectExtension
{
    ...
    /// <param name="go"></param>
    public static float ScrollToBeBottom(this ScrollRect scrollRect, GameObject go, float speed)
    {
        const float align = 0.0f;
        return ScrollToCore(scrollRect, go, align, speed);
    }
    ...
    /// <param name="scrollRect"></param>
    /// <param name="go"></param>
    public static float ScrollToCentering(this ScrollRect scrollRect, GameObject go, float speed)
    {
    ...
    /// <param name="scrollRect"></param>
    /// <param name="go"></param>
    public static float ScrollToBeTop(this ScrollRect scrollRect, GameObject go, float speed)
    {
    ...
    /// <returns></returns>
    static private float ScrollToCore(ScrollRect scrollRect, GameObject go, float align, float speed)
    {
        ...
        DOTween.To(() => scrollRect.verticalNormalizedPosition, (x) => scrollRect.verticalNormalizedPosition = x, normalizedPos, speed).SetEase(Ease.Linear);
